...
class ResearchManager:
  ...
  async def write_report(self, query: str, search_results: list[str]) -> ReportData:
    """ Write the report for the query from search results """
  ...
  async def send_email(self, report: ReportData, recipient_email: str) -> None:
      print("Writing email...")
      await Runner.run(email_agent, report.markdown_report, recipient_email)
      print("Email sent")
      return report


if __name__ == "__main__":
    asyncio.run(ResearchManager().run("What is the capital of France?"))
